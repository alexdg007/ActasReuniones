...
<head>
	...
	<title>Actas Pana - Fundacion universitaria Unipanamericana</title>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                {% if site_url %}
                                    <li><!--<a href="{{ site_url }}">{% trans 'View site' %}</a>--><a href="http://unipanamericana.edu.co/">{% trans 'Unipanamericana' %}</a></li>
                                {% endif %}
